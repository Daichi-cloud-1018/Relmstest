...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $product = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => $this->seedImage('strawberry.png'),
        ...
        $product = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => $this->seedImage('orange.png'),
        ...
        $product = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => $this->seedImage('watermelon.png'),
        ...
        $product = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => $this->seedImage('peach.png'),
        ...
        $product = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => $this->seedImage('muscat.png'),
        ...
        $product = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => $this->seedImage('pineapple.png'),
        ...
        $product = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => $this->seedImage('grapes.png'),
        ...
        $product = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => $this->seedImage('banana.png'),
        ...
        $product = [
            'name' => 'メロン',
            'price' => 900,
            'image' => $this->seedImage('melon.png'),
    ...
    /**
     * コピー元の public/img から storage/app/public/products へ画像を配置し、DB に保存するパスを返す。
     */
    private function seedImage(string $filename): string
    {
        ...
        if (is_file($source) && Storage::disk('public')->missing($target)) {
